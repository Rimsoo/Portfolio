<template>
	<p>
		La Programmation Orientée Objet (POO) est un concept de programmation permettant de structurer et de transiter des données par "bloc" désignant un concept, une idée ou toute autre entité, ces blocs sont nommés Objets. Ce concept repose sur 3 principes : l'encapsulation, le polymorphisme et l'héritage.
		<br> 
