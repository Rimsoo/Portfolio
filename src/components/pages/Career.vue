                ...
                <div class="mb-5">
                    ...
                    <div class="border-l border-black pl-2">
                        ...
                        <ul class="list-disc ml-10 mt-2">
                            <li>
                                L'étude du besoin des outils logiciels servant de passerelles entre les différentes briques applicatives de l'ALM (Application Lifecycle Management) : Prendre en compte tout particulièrement les contraintes de l'architecture internationale du système d'information, ainsi que le besoin de sécurisation des données hébergées (contrôle d'accès aux données, pérennisation et accessibilité des informations...)
                            </li>
                            <li>
